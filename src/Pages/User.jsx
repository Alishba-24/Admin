...
const User = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(registerUser(newUser));  // Dispatch action to store the new user
    navigate('/userpage', { state: formData });  // Navigate to user page
  };
...
<div className="flex gap-3">
          ...
          <button type="submit" className="w-full bg-blue-600 text-white font-semibold rounded-lg py-2">Register Yourself</button>
        </form>
      </div>
    </div>
  );
